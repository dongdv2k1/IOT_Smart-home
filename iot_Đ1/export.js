...
function exportChart(con, io) {
    ...
    con.query(sql1, function (err, result) {
        ...
        result.forEach(function (value) {
            ...
            console.log( value.Temperature + " " + value.Humidity + " " + value.Light);
            io.sockets.emit('server-update-data', { id: value.ID, temp: value.Temperature, humi: value.Humidity, light: value.Light })
        })
