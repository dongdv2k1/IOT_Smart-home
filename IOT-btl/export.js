...
function exportChart(con, io) {
    ...
    con.query(sql1, function (err, result) {
        ...
        result.forEach(function (value) {
            ...
            newTemp1 = value.Temperature1
            newHumi1 = value.Humidity1
            newLight1 = value.Light1
            console.log(m_time + " " + value.Temperature + " " + value.Humidity + " " + value.Light);
            console.log(m_time + " " + value.Temperature1 + " " + value.Humidity1 + " " + value.Light1);
            io.sockets.emit('server-update-data', { id: value.ID, time: m_time, temp: value.Temperature, humi: value.Humidity, light: value.Light,temp1: value.Temperature1, humi1: value.Humidity1, light1: value.Light1 })
